 ...
 * total). In addition, an issue time stamp and optional information about the
 * license holder is contained.
 * <p>
 * This class is <em>not</em> trusted by the license notary. As a result, the
 * license manager validates and verifies the state of this object itself
 * whenever necessary.
 * <p>
 * In general, all properties may be <tt>null</tt> which indicates that this
 * information is not (yet) available and should be ignored. Note however that
 * validation may fail if certain properties are not available.
 * <p>
 * Subclasses are encouraged to use the <tt>firePropertyChange</tt> methods to
 * notify all listeners of all property events. Subclasses <em>must</em> also
 * implement the JavaBean pattern in order to be usable.
 * <p>
...
public class LicenseContent implements Serializable, Cloneable {
	 ...
	 * by the issuer. The default is <tt>null</tt>.
	 * 
	 * @see #getIssuer()
	...
	/**
	 * Sets the legal entity (i.e. the user) to which the license is granted by
	 * the issuer.
	 * 
	 * @see #setIssuer(X500Principal)
	 * @param holder
	 *            New value of bound property <tt>holder</tt>.
	 */
	...
	/**
	 * Returns the legal entity which grants the license to the holder. The
	 ...
	 * @param issuer
	 *            New value of bound property <tt>issuer</tt>.
	 */
	...
	/**
	 * Returns the abstract description of the entity which needs to be licensed
	 * in order for it to be used - it could be the name of a software
	 * application like e.g. "TrueMirror". The default is <tt>null</tt>.
	 * 
	...
	/**
	 * Sets the abstract description of the entity which needs to be licensed in
	 * order for it to be used - it could be the name of a software application
	 * like e.g. "TrueMirror".
	 * 
	 * @param subject
	 *            New value of bound property <tt>subject</tt>.
	 */
	...
	/**
	 * Returns the time when the license represented by this license content has
	 * been issued. The default is <tt>null</tt>.
	 * 
	...
	/**
	 * Sets the time when the license represented by this license content has
	 * been issued.
	 * 
	 * @param issued
	 *            New value of bound property <tt>issued</tt>.
	 */
	...
	/**
	 * Returns the time when the license begins to be valid. The default is
	 * <tt>null</tt>.
	 * 
	 ...
	 * 
	 * @param notBefore
	 *            New value of bound property <tt>notBefore</tt>.
	 */
	...
	/**
	 * Returns the time when the license ends to be valid. The default is
	 * <tt>null</tt>.
	 * 
	 ...
	 * 
	 * @param notAfter
	 *            New value of bound property <tt>notAfter</tt>.
	 */
	...
	/**
	 * Returns the type of entity which needs to license the license subject in
	 * order to use it. This could be a computer or a user or something else.
	...
	/**
	 * Sets the type of entity which needs to license the license subject in
	 * order to use it. This could be a computer or a user or something else.
	 * 
	 * @param consumerType
	 *            New value of bound property <tt>consumerType</tt>.
	 */
	...
	/**
	 * Returns the amount of consumers which are allowed to license the subject
	 * with this license. The default is <tt>1</tt>.
	 * 
	...
	/**
	 * Sets the amount of consumers which are allowed to license the subject
	 * with this license.
	 * 
	 * @param consumerAmount
	 *            New value of bound property <tt>consumerAmount</tt>.
	 */
	public void setConsumerAmount(int consumerAmount) {
		int oldConsumerAmount = this.consumerAmount;
		this.consumerAmount = consumerAmount;
		firePropertyChange("consumerAmount", new Integer(oldConsumerAmount),
				new Integer(consumerAmount)); // NOI18N
	}

	/**
	 * Returns the value of the property <tt>info</tt>. This property may be
	 * used by applications to store public license text for informational
	 * purposes. Its value is displayed in the
	 * {@link de.schlichtherle.license.wizard.LicensePanel}. The default is
	 * <tt>null</tt>.
	 */
	...
	/**
	 * Sets the value of the property <tt>info</tt>. This property may be
	 * used by applications to store public license text for informational
	 * purposes. Its value is displayed in the
	 * {@link de.schlichtherle.license.wizard.LicensePanel}.
	 * 
	 * @param info
	 *            New value of bound property <tt>info</tt>.
	 */
	...
	/**
	 * Returns the value of the property extra. This property may be used by
	 * applications to store arbitrary private data which is not displayed to
	 * the user or checked by this library. The default is <tt>null</tt>.
	 * 
	...
	/**
	 * Sets the value of the property extra. This property may be used by
	 * applications to store arbitrary private data which is not displayed to
	 * the user or checked by this library.
	 * <p>
	 ...
	 * {@link de.schlichtherle.xml.PersistenceServiceException} is thrown by
	 * these methods instead.)
	 * 
	 * @param extra
	 *            New value of bound property <tt>extra</tt>. This object
	 *            must either implement the JavaBeans specification or have
	 *            direct support by the class {@link java.beans.XMLEncoder},
	 *            such as strings and primitive type wrapper objects.
	 * 
	 * @since The TrueLicense Library Collection 1.19.
	 */
	...
	public void setIp(String ip) {
		...
		this.ip = ip;
		firePropertyChange("ip", oldIp, ip); // NOI18N
	}

	public int hashCode() {
		return getConsumerAmount() + hashCode(getConsumerType())
				+ hashCode(getHolder()) + hashCode(getInfo())
				+ hashCode(getIssued()) + hashCode(getIssuer())
				+ hashCode(getNotAfter()) + hashCode(getNotBefore())
				+ hashCode(getSubject()) + hashCode(getIp());
	}
	...
	/**
	 * Returns <tt>true</tt> if and only if <tt>object</tt> is an instance
	 * of <tt>LicenseContent</tt> and their properties are considered equal.
	 */
	public boolean equals(Object object) {
		...
		return other.getConsumerAmount() == getConsumerAmount()
				...
				&& isNullOrEquals(other.getIp(), getIp());
	}
